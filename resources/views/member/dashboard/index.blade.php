...
<section>
    <div class="bg-theme-1" style="padding: 6em 0 2em 0">
        <main class="container text-center text-white">
            ...
            <p>Selamat datang <span class="fw-bold">{{ Auth::user()->name }}</span> di Tes Online Spandiv.<br>Anda dapat melakukan tes online disini dengan memilih menu tes yang ada di bawah ini.</p>
        </main>
    </div>
</section>
...
<section class="container py-2">
    <div class="content">
        <div class="row justify-content-center">
            ...
            <div class="col-auto">
                <a href="#" class="btn btn-md btn-block btn-outline-dark border-0 fw-bold py-3 my-3">

    ...
    <table width="100%" border="1">
        ...
        @foreach($letters as $key=>$letter)
          <tr>
              ...
              <td style="padding-left: 10px; padding-right: 10px;">{{ \App\Http\Controllers\Test\PapikostickController::analyze($result->result[$letter], $description->description[$letter]) }}</td>
